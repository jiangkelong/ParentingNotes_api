...
{
    public class NoteHuwaiService : NoteBaseService<NoteHuwai>, INoteHuwaiService
    {
        /// <summary>
        /// 重写
        /// 生成总结说明
        ...
        /// <returns></returns>
        public override NoteSummary CreateSummary(NoteHuwai parm)
        {
            ...
            sy.summary = $"溜达了{Utils.TwoTimeInterval(parm.begin_time, parm.end_time)}。";
            return sy;
        }
    }
}
